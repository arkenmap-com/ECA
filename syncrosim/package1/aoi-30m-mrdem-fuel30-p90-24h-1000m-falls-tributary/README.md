...
- 24 hourly records from Smallwood station 404 for 20 August 2018, the
  observed day nearest the June–August 2016–2025 daily-noon FWI P90.
...
python3 fire_sim_pipeline.py \
  --config syncrosim/package1/aoi-30m-mrdem-fuel30-p90-24h-1000m-falls-tributary/package1_config.json \
  --stage prepare
```

The 257-run Cell2Fire ensemble has been completed for this 1,000 m grid. The
result is a conditional burn-frequency experiment under one fixed 24-hour
weather sequence, not an annual wildfire probability or operational forecast.
